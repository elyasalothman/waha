...
export const CATALOG: CatalogItem[] = [
  ...
  { id: "abaar", category: "games", lane: "play", audience: P, icon: "Droplets", title: { ar: "آبار", en: "Wells" }, blurb: { ar: "اكشف الرمل حتى الماء، وتجنّب الحفر الجافة", en: "Open the sand to water, and spare the dry pits" } },
  { id: "majra", category: "games", lane: "play", audience: P, icon: "Wind", title: { ar: "مجرى", en: "Channel" }, blurb: { ar: "أدِر المجاري حتى تبلغ الواحة", en: "Turn the channels until they reach the oasis" } },
  { id: "kutal", category: "games", lane: "play", audience: P, icon: "Blocks", title: { ar: "كتل", en: "Blocks" }, blurb: { ar: "ضع الكتلة وامسح الصف والعمود", en: "Place a block, and clear the row and column" } },
  ...
  { id: "tetris", category: "games", lane: "play", audience: P, icon: "Layers", title: { ar: "تتريس", en: "Tetris" }, blurb: { ar: "لبنات كلاسيكية مع احتفاظ وشبح", en: "Classic pieces, with hold and a ghost" } },
  { id: "connect4", category: "games", lane: "play", audience: P, icon: "Columns3", title: { ar: "أربعة في صف", en: "Connect four" }, blurb: { ar: "ضد واحة أو مع جليس بجانبك", en: "Against Waha or the person beside you" } },
