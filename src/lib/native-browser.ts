 ...
 *
 * House / sister https doors (مداد، تهجد، مواقعنا، محسن، ألعاب، حياة)
 * open in a first-party in-app WKWebView with Arabic chrome
 * (title + زر «رجوع لواحة») — never Safari / SFSafariViewController /
 * `@capacitor/browser`.
 *
 * True external (gov) portals still use `@capacitor/browser` on iOS.
 */
...
/** Apex + every *.alhajda.com house / sister product, including مداد. */
