...
const strings = {
  ...
  gamesBlurb: { ar: "ورشة واحة — كلمة وآبار ومجرى وكتل وذاكرة — وباب إلى باحة لُمعة", en: "Waha’s workshop — Kalima, wells, channel, blocks, and memory — and a door to Luma’s yard" },
  workshop: { ar: "ورشة واحة", en: "Waha workshop" },
  moreGames: { ar: "استراحة أطول", en: "A longer break" },
  sfxOn: { ar: "صوت خفيف", en: "Soft sound" },
  sfxOff: { ar: "صامت", en: "Muted" },
